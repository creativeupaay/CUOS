...
/**
 * Safely seed roles and permissions without deleting existing data
 * This version uses upsert to create or update roles/permissions
 */
async function seedRolesAndPermissionsSafe() {
    try {
        ...
        logger.info(`\nUpserted ${upsertedRoles.length} roles`);
