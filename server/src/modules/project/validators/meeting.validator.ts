...
export const createIndividualMeetingSchema = z.object({
    body: z.object({
        title: z.string().min(1, 'Meeting title is required').trim(),
        description: z.string().optional(),
        type: z.enum(['internal', 'external']),
...
export const updateIndividualMeetingSchema = z.object({
    params: z.object({
        id: z.string().min(1, 'Meeting ID is required'),
    }),
    body: z.object({
...
export const getIndividualMeetingsSchema = z.object({
    query: z.object({
        type: z.enum(['internal', 'external']).optional(),
        startDate: z.string().or(z.date()).optional(),
        endDate: z.string().or(z.date()).optional(),
...
export const getIndividualMeetingByIdSchema = z.object({
    params: z.object({
        id: z.string().min(1, 'Meeting ID is required'),
    }),
});

export const deleteIndividualMeetingSchema = z.object({
    params: z.object({
        id: z.string().min(1, 'Meeting ID is required'),
    }),
});
