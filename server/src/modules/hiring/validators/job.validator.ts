...
export const createJobSchema = z.object({
    body: z.object({
        ...
        managers: z.array(z.string().regex(objectIdRegex, 'Invalid employee ID')).optional().default([]),
...
export const updateJobSchema = z.object({
    body: z.object({
        ...
        managers: z.array(z.string().regex(objectIdRegex, 'Invalid employee ID')).optional(),
